...
156      if(a(i,l)==2.and.a(i+1,l+1)==5.and.(a(i+2,l+2)/=0.and.a(i+2,l+2)/=3))then
...
41      if((a(i,l)==1).and.(a(i+1,l+1)==0.or.a(i+1,l+1)==3).and.a(i+2,l+2)==5)then
	a(i,l)=5
	a(i+1,l+1)=5
	a(i+2,l+2)=1
	i=i+2
...
42      enddo
	...
	i=c
	l=d
43      if(a(i,l)==1.and.a(i+1,l+1)==5)then
	...
	b=1
        ...
        if(b==1)goto 46
44      if(a(i,l)==1.and.a(i+1,l-1)==5)then
        if(a(i+2,l-2)/=0.and.a(i+2,l-2)/=3)then
	if((a(i+2,l)/=0.and.a(i+2,l)/=3).or.a(i,l-2)/=5)then
        if((a(i+1,l+1)/=1.and.a(i+1,l+1)/=2).or.(a(i+2,l+2)/=0.and.a(i+2,l+2)/=3))then
	a(i,l)=5
...
46      if(a(i,l)==1.and.i==12)a(i,l)=2	
        call ito
	write(*,*)'     1.',' 2.',' 3.',' 4.',' 5.',' 6.',' 7.',' 8.'
        write(*,*)'   ***********DAMA***********'
